...
public class Configuration {
  ...
  public void setLogImpl(Class<? extends Log> logImpl) {
    if (logImpl != null) {
      ...
      LogFactory.useCustomLogging(this.logImpl);//设置日志类的构造方法
    }
  }
  ...
  private void parsePendingResultMaps() {//解析所有未解析的ResultMap
    ...
    synchronized (incompleteResultMaps) {
      ...
      do {
        ...
        while (iterator.hasNext()) {//循环遍历所有ResultMap
          try {
            iterator.next().resolve();//解析该ResultMap
            iterator.remove();//从incompleteResultMaps中删除该节点
            resolved = true;
